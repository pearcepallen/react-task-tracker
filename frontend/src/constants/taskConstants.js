...
export const TASK_TOGGLE_REMINDER_REQUEST = 'TASK_TOGGLE_REMINDER_REQUEST'
export const TASK_TOGGLE_REMINDER_SUCCESS = 'TASK_TOGGLE_REMINDER_SUCCESS'
export const TASK_TOGGLE_REMINDER_FAIL = 'TASK_TOGGLE_REMINDER_FAIL'